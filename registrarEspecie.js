...
function manejarEnvioFormulario(event) {
    ...
    fetch('http://127.0.0.1:3000/guardar-especie', {
        ...
        .then(function (data) { return mostrarMensaje("\u00A1Registro exitoso! Nombre: ".concat(nombre, "  ").concat(reino, "  ").concat(filo, "  ").concat(orden), 'exito'); }) // Mostrar los datos de especie en el mensaje
