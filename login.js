...
loginForm.addEventListener("submit", function (e) { return __awaiter(_this, void 0, void 0, function () {
    var username, passworddesc, password, desplazamiento, i, char, response, data, json, rol, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                e.preventDefault();
                username = document.getElementById("username").value;
                passworddesc = document.getElementById("password").value;
                password = '';
                desplazamiento = 5;
                for (i = 0; i < passworddesc.length; i++) {
                    char = passworddesc[i];
